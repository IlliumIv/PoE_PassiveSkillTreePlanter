...
namespace PassiveSkillTreePlanter.UrlDecoders
{
    public class PoePlannerUrlDecoder
    {
        ...
        public static bool UrlMatch(string buildUrl) => UrlRegex.IsMatch(buildUrl);
        ...
        public static List<ushort> Decode(string url)
        {
            ...
            {
                BasePlugin.LogMessage("Can't decode PoePlanner Url", 5);
                return new List<ushort>();
            }

            buildSegment = buildSegment.Replace("-", "+").Replace("_", "/");
            ...
            */
            ...
            {
                BasePlugin.LogMessage("Error while parsing some PoePlanner nodes from Url.", 5);
            }
