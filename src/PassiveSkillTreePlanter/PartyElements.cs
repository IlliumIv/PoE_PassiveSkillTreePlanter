...
namespace PassiveSkillTreePlanter
{
    ...
    {
        public PartyElements(PassiveSkillTreePlanter core)
        {
            Core = core;
        }

        private PassiveSkillTreePlanter Core { get; }
        ...
        public static List<string> ListOfPlayersInParty()
        {
            ...
            try
            {
                var baseWindow = new CustomIngameUIElements(GameController.Instance.Game.IngameState.IngameUi.Address)
                    .PartyList;
                if (baseWindow != null)
                {
    ...
    public class PartyElementWindow
    {
        ...
        {
            return
                $"PlayerName: {PlayerName}, Data.PlayerEntity.Distance: {Data.PlayerEntity?.InternalEntity.Distance.ToString() ?? "Null"}";
        }
    }

    public class PlayerData
    {
        public EntityWrapper PlayerEntity { get; set; }
    }
}